                ...
                <div class="item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption">
                            ...
                            <h2>You're Welcome to Ummah Tazhkiir </h2>
                            <p>Ummah Tazhkiir gives you access to free <strong>Islamic Books,</strong> <strong>Quran,</strong> <strong>Dua & Adhkar,</strong> <strong>Arabic study,</strong><strong>Islamic Audio and Islamic Videos</strong></p>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="center-content">
                            ...
                            <p class="lead">Subscribe to Ummah Tazhkiir newsletter to access any update and information.</p>
                        </div>
                        <div class="form-group">
        ...
        <section class="category-filter section-padding">
            <div class="container">
                <div class="center-content">
                    ...
                    <span class="underline center"></span>
                    <p class="lead" id="hadith_intro">All the recently uploaded islamic-books and pdfs in different languages from Ummah Tazhkiir collection are shown here.</p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 widget-container">
                    <div id="text-2" class="widget widget_text">
                        <h3 class="footer-widget-title">About &nbsp; Ummah Tazhkiir</h3>
                        <span class="underline left"></span>
