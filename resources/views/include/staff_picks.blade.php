...
<section class="team staff-picks">
    <div class="container">
        <div class="center-content">
            ...
            <p class="lead" style="color: yellow">All the recently uploaded islamic-books and pdfs in different languages from Ummah Tazhkiir collection are shown here.</p>
        </div>
